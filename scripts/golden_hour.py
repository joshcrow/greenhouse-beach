...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--sunset", action="store_true", help="Show today's sunset time"
    )
    parser.add_argument("--golden", action="store_true", help="Show golden hour time")
    parser.add_argument(
        "--seasonal", action="store_true", help="Show seasonal golden hour"
    )
    parser.add_argument(
        "--check", action="store_true", help="Check if now is golden hour"
    )
