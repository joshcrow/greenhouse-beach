...
**Public URL:** [straightouttacolington.com](https://straightouttacolington.com) (Cloudflare Access protected)

- **Real-time sensor data** – Temperature and humidity with staleness indicators
- **Interactive charts** – 24h, 7-day, and 30-day historical views
- **AI Narrative** – Auto-refreshing greenhouse commentary
...
**Riddle Game (Email + Web)**
- **Daily riddle** – Generated by AI, themed to greenhouse/weather
- **Email guesses** – Reply with `GUESS: your answer` or put answer in body
- **Web guesses** – Submit via dashboard with instant AI feedback
- **Scoring** – First correct = 3 pts, subsequent = 2 pts, wrong = 0 pts
- **Leaderboard** – Persistent seasonal rankings
...
│                                            ▼                  │
│  ┌──────────────────┐              ┌──────────────────────┐  │
│  │  Storyteller Pi  │              │   greenhouse-web     │  │
│  │  (Raspberry Pi 5)│              │   (FastAPI+React)    │  │
│  │                  │              │   :8000              │  │
│  │  Docker:         │◄─── JSON ───►└──────────────────────┘  │
│  │  - mosquitto     │                                        │
│  │  - storyteller   │              ┌──────────────────────┐  │
│  │  - web           │◄─── MQTT ───►│    Greenhouse Pi     │  │
│  │  - cloudflared   │              │    (HA + Camera)     │  │
│  └──────────────────┘              └───────────┬──────────┘  │
│                                                │              │
└────────────────────────────────────────────────┼──────────────┘
                                                 │ GREENHOUSE_IOT
...
| Node | Hardware | Role |
|------|----------|------|
| **Storyteller** | Raspberry Pi 5 | MQTT broker, AI narrative, email, web API |
...
| **Cloudflare** | Edge | Tunnel ingress, Access authentication |
...
- [x] Web dashboard (real-time sensor view) ✓
- [x] Interactive riddle game with leaderboard ✓
